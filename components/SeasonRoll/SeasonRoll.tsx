            ...
            <Link href={`/tv/${showId}/${toUrlFriendly(showName)}/season/${season.season_number}`}>
              <Grid sx={classes.seasonImg}>
                <Image
                  fill
                  placeholder="blur"
                  blurDataURL={formatImgSrc('https://image.tmdb.org/t/p/w138_and_h175_face/', season.poster_path)}
                  src={formatImgSrc('https://image.tmdb.org/t/p/w138_and_h175_face/', season.poster_path)}
                  sizes={formatImgSrc('https://image.tmdb.org/t/p/w138_and_h175_face/', season.poster_path)}
              ...
              <Grid sx={classes.seasonNames}>
                <Typography sx={classes.seasonName}>{season.name}</Typography>
                <Typography sx={classes.sub}>{season.episode_count} episodes</Typography>
